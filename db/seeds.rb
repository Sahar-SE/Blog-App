...
post1 = Post.create(authorId: user1, title: 'Hello', text: 'This is my first post')
post2 = Post.create(authorId: user1, title: 'Hello', text: 'This is my second post')
post3 = Post.create(authorId: user2, title: 'Hello', text: 'This is my first post')
post4 = Post.create(authorId: user2, title: 'Hello', text: 'This is my second post')
post5 = Post.create(authorId: user3, title: 'Hello', text: 'This is my first post')

comment1 = Comment.create(postId: post1, authorId: user1, text: 'Hi Lilly!' )
comment2 = Comment.create(postId: post1, authorId: user2, text: 'Hi Tom!' )
comment3 = Comment.create(postId: post2, authorId: user2, text: 'Hi!' )
comment4 = Comment.create(postId: post2, authorId: user1, text: 'Hey!' )
comment5 = Comment.create(postId: post3, authorId: user1, text: 'Hi there!' )
comment6 = Comment.create(postId: post5, authorId: user3, text: 'Hello!' )
comment6 = Comment.create(postId: post4, authorId: user4, text: 'Hello!' )
