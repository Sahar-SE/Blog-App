...
post2 = Post.create(user_id: user1, title: 'Hello', text: 'This is my second post')
post3 = Post.create(user_id: user2, title: 'Hello', text: 'This is my first post')
post4 = Post.create(user_id: user2, title: 'Hello', text: 'This is my second post')
post5 = Post.create(user_id: user3, title: 'Hello', text: 'This is my first post')

comment1 = Comment.create(postId: post1, user_id: user1, text: 'Hi Lilly!' )
comment2 = Comment.create(postId: post1, user_id: user2, text: 'Hi Tom!' )
comment3 = Comment.create(postId: post2, user_id: user2, text: 'Hi!' )
comment4 = Comment.create(postId: post2, user_id: user1, text: 'Hey!' )
comment5 = Comment.create(postId: post3, user_id: user1, text: 'Hi there!' )
comment6 = Comment.create(postId: post5, user_id: user3, text: 'Hello!' )
comment6 = Comment.create(postId: post4, user_id: user4, text: 'Hello!' )
