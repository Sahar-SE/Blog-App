...
post2 = Post.create(user: user1, title: 'Hello', text: 'This is my second post')
post3 = Post.create(user: user2, title: 'Hello', text: 'This is my first post')
post4 = Post.create(user: user3, title: 'Hello', text: 'This is my second post')
post5 = Post.create(user: user4, title: 'Hello', text: 'This is my first post')
post6 = Post.create(user: user4, title: 'Hello', text: 'This is my first post')

comment1 = Comment.create(post: post1,user: user1, text: 'Hi Lilly!' )
comment2 = Comment.create(post: post1,user: user2, text: 'Hi Tom!' )
comment3 = Comment.create(post: post2,user: user2, text: 'Hi!' )
comment4 = Comment.create(post: post2,user: user1, text: 'Hey!' )
comment5 = Comment.create(post: post3,user: user1, text: 'Hi there!' )
comment6 = Comment.create(post: post5, user: user3, text: 'Hello!' )
comment6 = Comment.create(post: post4, user: user4, text: 'Hello!' )
